...
// GetClientMutationId returns ClusterAgentTokenCreateInput.ClientMutationId, and is useful for accessing the field via an interface.
func (v *ClusterAgentTokenCreateInput) GetClientMutationId() string { return v.ClientMutationId }

// GetOrganizationId returns ClusterAgentTokenCreateInput.OrganizationId, and is useful for accessing the field via an interface.
func (v *ClusterAgentTokenCreateInput) GetOrganizationId() string { return v.OrganizationId }

// GetDescription returns ClusterAgentTokenCreateInput.Description, and is useful for accessing the field via an interface.
func (v *ClusterAgentTokenCreateInput) GetDescription() string { return v.Description }

// GetClusterId returns ClusterAgentTokenCreateInput.ClusterId, and is useful for accessing the field via an interface.
func (v *ClusterAgentTokenCreateInput) GetClusterId() string { return v.ClusterId }

// GetJobTokensEnabled returns ClusterAgentTokenCreateInput.JobTokensEnabled, and is useful for accessing the field via an interface.
func (v *ClusterAgentTokenCreateInput) GetJobTokensEnabled() bool { return v.JobTokensEnabled }

// GetAllowedIpAddresses returns ClusterAgentTokenCreateInput.AllowedIpAddresses, and is useful for accessing the field via an interface.
func (v *ClusterAgentTokenCreateInput) GetAllowedIpAddresses() string { return v.AllowedIpAddresses }
...
// GetClientMutationId returns ClusterAgentTokenRevokeInput.ClientMutationId, and is useful for accessing the field via an interface.
func (v *ClusterAgentTokenRevokeInput) GetClientMutationId() string { return v.ClientMutationId }

// GetId returns ClusterAgentTokenRevokeInput.Id, and is useful for accessing the field via an interface.
func (v *ClusterAgentTokenRevokeInput) GetId() string { return v.Id }

// GetOrganizationId returns ClusterAgentTokenRevokeInput.OrganizationId, and is useful for accessing the field via an interface.
func (v *ClusterAgentTokenRevokeInput) GetOrganizationId() string { return v.OrganizationId }

// Autogenerated input type of ClusterAgentTokenUpdate
type ClusterAgentTokenUpdateInput struct {
	// Autogenerated input type of ClusterAgentTokenUpdate
	ClientMutationId string `json:"clientMutationId"`
	// Autogenerated input type of ClusterAgentTokenUpdate
	Id string `json:"id"`
...
// GetClientMutationId returns ClusterAgentTokenUpdateInput.ClientMutationId, and is useful for accessing the field via an interface.
func (v *ClusterAgentTokenUpdateInput) GetClientMutationId() string { return v.ClientMutationId }

// GetId returns ClusterAgentTokenUpdateInput.Id, and is useful for accessing the field via an interface.
func (v *ClusterAgentTokenUpdateInput) GetId() string { return v.Id }

// GetOrganizationId returns ClusterAgentTokenUpdateInput.OrganizationId, and is useful for accessing the field via an interface.
func (v *ClusterAgentTokenUpdateInput) GetOrganizationId() string { return v.OrganizationId }

// GetDescription returns ClusterAgentTokenUpdateInput.Description, and is useful for accessing the field via an interface.
func (v *ClusterAgentTokenUpdateInput) GetDescription() string { return v.Description }

// GetJobTokensEnabled returns ClusterAgentTokenUpdateInput.JobTokensEnabled, and is useful for accessing the field via an interface.
func (v *ClusterAgentTokenUpdateInput) GetJobTokensEnabled() bool { return v.JobTokensEnabled }

// GetAllowedIpAddresses returns ClusterAgentTokenUpdateInput.AllowedIpAddresses, and is useful for accessing the field via an interface.
func (v *ClusterAgentTokenUpdateInput) GetAllowedIpAddresses() string { return v.AllowedIpAddresses }
...
type __createClusterAgentTokenInput struct {
	Input ClusterAgentTokenCreateInput `json:"input"`
}

// GetInput returns __createClusterAgentTokenInput.Input, and is useful for accessing the field via an interface.
func (v *__createClusterAgentTokenInput) GetInput() ClusterAgentTokenCreateInput { return v.Input }
...
type __revokeClusterAgentTokenInput struct {
	Input ClusterAgentTokenRevokeInput `json:"input"`
}

// GetInput returns __revokeClusterAgentTokenInput.Input, and is useful for accessing the field via an interface.
func (v *__revokeClusterAgentTokenInput) GetInput() ClusterAgentTokenRevokeInput { return v.Input }
...
type __updateClusterAgentTokenInput struct {
	Input ClusterAgentTokenUpdateInput `json:"input"`
}

// GetInput returns __updateClusterAgentTokenInput.Input, and is useful for accessing the field via an interface.
func (v *__updateClusterAgentTokenInput) GetInput() ClusterAgentTokenUpdateInput { return v.Input }
...
// GetClientMutationId returns createClusterAgentTokenClusterAgentTokenCreateClusterAgentTokenCreatePayload.ClientMutationId, and is useful for accessing the field via an interface.
func (v *createClusterAgentTokenClusterAgentTokenCreateClusterAgentTokenCreatePayload) GetClientMutationId() *string {
	return v.ClientMutationId
}
...
// GetJobTokensEnabled returns createClusterAgentTokenClusterAgentTokenCreateClusterAgentTokenCreatePayloadClusterAgentTokenClusterToken.JobTokensEnabled, and is useful for accessing the field via an interface.
func (v *createClusterAgentTokenClusterAgentTokenCreateClusterAgentTokenCreatePayloadClusterAgentTokenClusterToken) GetJobTokensEnabled() bool {
...
// GetJobTokensEnabled returns getClusterAgentTokensOrganizationClusterAgentTokensClusterAgentTokenConnectionEdgesClusterAgentTokenEdgeNodeClusterToken.JobTokensEnabled, and is useful for accessing the field via an interface.
func (v *getClusterAgentTokensOrganizationClusterAgentTokensClusterAgentTokenConnectionEdgesClusterAgentTokenEdgeNodeClusterToken) GetJobTokensEnabled() bool {
	return v.JobTokensEnabled
}
...
// GetClientMutationId returns revokeClusterAgentTokenClusterAgentTokenRevokeClusterAgentTokenRevokePayload.ClientMutationId, and is useful for accessing the field via an interface.
func (v *revokeClusterAgentTokenClusterAgentTokenRevokeClusterAgentTokenRevokePayload) GetClientMutationId() *string {
	return v.ClientMutationId
}
...
// GetClientMutationId returns updateClusterAgentTokenClusterAgentTokenUpdateClusterAgentTokenUpdatePayload.ClientMutationId, and is useful for accessing the field via an interface.
func (v *updateClusterAgentTokenClusterAgentTokenUpdateClusterAgentTokenUpdatePayload) GetClientMutationId() *string {
	return v.ClientMutationId
}
...
// GetJobTokensEnabled returns updateClusterAgentTokenClusterAgentTokenUpdateClusterAgentTokenUpdatePayloadClusterAgentTokenClusterToken.JobTokensEnabled, and is useful for accessing the field via an interface.
func (v *updateClusterAgentTokenClusterAgentTokenUpdateClusterAgentTokenUpdatePayloadClusterAgentTokenClusterToken) GetJobTokensEnabled() bool {
	return v.JobTokensEnabled
}
...
mutation revokeClusterAgentToken ($input: ClusterAgentTokenRevokeInput!) {
...
mutation updateClusterAgentToken ($input: ClusterAgentTokenUpdateInput!) {
	clusterAgentTokenUpdate(input: $input) {
		clusterAgentToken {
			id
			description
			jobTokensEnabled
