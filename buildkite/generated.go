...
// updateClusterClusterCreateClusterCreatePayload includes the requested fields of the GraphQL type ClusterCreatePayload.
// The GraphQL type's documentation follows.
//
// Autogenerated return type of ClusterCreate.
type updateClusterClusterCreateClusterCreatePayload struct {
	// A unique identifier for the client performing the mutation.
	ClientMutationId string `json:"clientMutationId"`
}

// GetClientMutationId returns updateClusterClusterCreateClusterCreatePayload.ClientMutationId, and is useful for accessing the field via an interface.
func (v *updateClusterClusterCreateClusterCreatePayload) GetClientMutationId() string {
	return v.ClientMutationId
}
...
type updateClusterResponse struct {
	// Create a cluster.
	ClusterCreate updateClusterClusterCreateClusterCreatePayload `json:"clusterCreate"`
}

// GetClusterCreate returns updateClusterResponse.ClusterCreate, and is useful for accessing the field via an interface.
func (v *updateClusterResponse) GetClusterCreate() updateClusterClusterCreateClusterCreatePayload {
	return v.ClusterCreate
}
...
mutation updateCluster ($organizationId: ID!, $name: String!, $description: String, $emoji: String, $color: String) {
	clusterCreate(input: {organizationId:$organizationId,name:$name,description:$description,emoji:$emoji,color:$color}) {
		clientMutationId
	}
}
