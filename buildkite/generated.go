...
// GetClientMutationId returns ClusterCreateInput.ClientMutationId, and is useful for accessing the field via an interface.
func (v *ClusterCreateInput) GetClientMutationId() string { return v.ClientMutationId }

// GetOrganizationId returns ClusterCreateInput.OrganizationId, and is useful for accessing the field via an interface.
func (v *ClusterCreateInput) GetOrganizationId() string { return v.OrganizationId }

// GetName returns ClusterCreateInput.Name, and is useful for accessing the field via an interface.
func (v *ClusterCreateInput) GetName() string { return v.Name }

// GetDescription returns ClusterCreateInput.Description, and is useful for accessing the field via an interface.
func (v *ClusterCreateInput) GetDescription() string { return v.Description }

// GetEmoji returns ClusterCreateInput.Emoji, and is useful for accessing the field via an interface.
func (v *ClusterCreateInput) GetEmoji() string { return v.Emoji }

// GetColor returns ClusterCreateInput.Color, and is useful for accessing the field via an interface.
func (v *ClusterCreateInput) GetColor() string { return v.Color }
...
// GetClientMutationId returns ClusterDeleteInput.ClientMutationId, and is useful for accessing the field via an interface.
func (v *ClusterDeleteInput) GetClientMutationId() string { return v.ClientMutationId }

// GetOrganizationId returns ClusterDeleteInput.OrganizationId, and is useful for accessing the field via an interface.
func (v *ClusterDeleteInput) GetOrganizationId() string { return v.OrganizationId }

// GetId returns ClusterDeleteInput.Id, and is useful for accessing the field via an interface.
func (v *ClusterDeleteInput) GetId() string { return v.Id }
...
// GetClientMutationId returns ClusterUpdateInput.ClientMutationId, and is useful for accessing the field via an interface.
func (v *ClusterUpdateInput) GetClientMutationId() string { return v.ClientMutationId }

// GetOrganizationId returns ClusterUpdateInput.OrganizationId, and is useful for accessing the field via an interface.
func (v *ClusterUpdateInput) GetOrganizationId() string { return v.OrganizationId }

// GetId returns ClusterUpdateInput.Id, and is useful for accessing the field via an interface.
func (v *ClusterUpdateInput) GetId() string { return v.Id }

// GetName returns ClusterUpdateInput.Name, and is useful for accessing the field via an interface.
func (v *ClusterUpdateInput) GetName() string { return v.Name }

// GetDescription returns ClusterUpdateInput.Description, and is useful for accessing the field via an interface.
func (v *ClusterUpdateInput) GetDescription() string { return v.Description }

// GetEmoji returns ClusterUpdateInput.Emoji, and is useful for accessing the field via an interface.
func (v *ClusterUpdateInput) GetEmoji() string { return v.Emoji }

// GetColor returns ClusterUpdateInput.Color, and is useful for accessing the field via an interface.
func (v *ClusterUpdateInput) GetColor() string { return v.Color }

// GetDefaultQueueId returns ClusterUpdateInput.DefaultQueueId, and is useful for accessing the field via an interface.
func (v *ClusterUpdateInput) GetDefaultQueueId() string { return v.DefaultQueueId }
...
type __createClusterInput struct {
	Input ClusterCreateInput `json:"input"`
}

// GetInput returns __createClusterInput.Input, and is useful for accessing the field via an interface.
func (v *__createClusterInput) GetInput() ClusterCreateInput { return v.Input }

// __deleteClusterInput is used internally by genqlient
type __deleteClusterInput struct {
	Input ClusterDeleteInput `json:"input"`
}

// GetInput returns __deleteClusterInput.Input, and is useful for accessing the field via an interface.
func (v *__deleteClusterInput) GetInput() ClusterDeleteInput { return v.Input }
...
type __updateClusterInput struct {
	Input ClusterUpdateInput `json:"input"`
}

// GetInput returns __updateClusterInput.Input, and is useful for accessing the field via an interface.
func (v *__updateClusterInput) GetInput() ClusterUpdateInput { return v.Input }
...
mutation deleteCluster ($input: ClusterDeleteInput!) {
	clusterDelete(input: $input) {
		clientMutationId
	}
}
`
