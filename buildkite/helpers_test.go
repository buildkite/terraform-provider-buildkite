...
// datasourceSchema is resourceSchema for a data source, whose Schema method takes its own request
// and response types rather than the resource ones.
func datasourceSchema(ctx context.Context, t *testing.T, d fwdatasource.DataSource) datasourceschema.Schema {
	t.Helper()
